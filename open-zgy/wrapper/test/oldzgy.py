...
There are two slightly different versions of this file. The one in
the pure Python implementation and the one in the wrapper. The OpenZGY
types being referred to have the same name both places but are technically
different types.
"""
##@package oldzgy
#@brief Consolidate old and new Python wrappers.

import zgy
from openzgycpp import SampleDataType, UnitDimension
